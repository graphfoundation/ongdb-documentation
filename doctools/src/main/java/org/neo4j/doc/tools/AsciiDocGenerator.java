...
public abstract class AsciiDocGenerator {
    ...
    protected void line(final Writer fw, final String string) throws IOException {
        fw.append(string);
        fw.append("\n");
    }
    ...
    public void addGithubTestSourceLink(String key, Class<?> source, String dir) {
    ...
    private void githubLink(String key, Class<?> source, String dir, String mainOrTest) {
        String path = "https://github.com/graphfoundation/ongdb-documentation/blob/{neo4j-git-tag}/";
        if (dir != null) {
            path += dir + "/";
        }
